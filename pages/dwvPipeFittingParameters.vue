...
export default {
	name: "DWVPipeFittingParametersPage",
	components: {
	...
	methods: {
		...mapActions("dWVPipeFittingParameters", [
			"fetchTableData",
			"addTableData",
			"deleteTableData",
			"updateTableData",
		]),
		...mapGetters("dWVPipeFittingParameters", ["getDWVPipeFittingParameters"]),
		initializeTableData(params = { page: 0, docsPerPage: 10 }) {
			this.initializeData(this.fetchTableData, this.getDWVPipeFittingParameters, params)
