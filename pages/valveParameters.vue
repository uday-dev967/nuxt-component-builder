...
export default {
	...
	methods: {
		...mapActions("valveParameters", ["fetchTableData", "addTableData", "deleteTableData", "updateTableData"]),
		...mapGetters("valveParameters", ["getValveParameters"]),
		initializeTableData(params = { page: 0, docsPerPage: 10 }) {
			this.initializeData(this.fetchTableData, this.getValveParameters, params)
