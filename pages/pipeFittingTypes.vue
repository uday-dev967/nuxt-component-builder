...
export default {
	...
	methods: {
		...mapActions("pipeFittingTypes", ["fetchTableData", "addTableData", "deleteTableData", "updateTableData"]),
		...mapGetters("pipeFittingTypes", ["getPipeFittingTypes"]),
		initializeTableData(params = { page: 0, docsPerPage: 10 }) {
			this.initializeData(this.fetchTableData, this.getPipeFittingTypes, params)
