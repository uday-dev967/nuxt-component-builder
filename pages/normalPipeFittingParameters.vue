...
export default {
	name: "NormalPipeFittingParametersPage",
	components: {
	...
	methods: {
		...mapActions("normalPipeFittingParameters", [
			"fetchTableData",
			"addTableData",
			"deleteTableData",
			"updateTableData",
		]),
		...mapGetters("normalPipeFittingParameters", ["getNormalPipeFittingParameters"]),
		initializeTableData(params = { page: 0, docsPerPage: 10 }) {
			this.initializeData(this.fetchTableData, this.getNormalPipeFittingParameters, params)
