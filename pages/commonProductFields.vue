...
export default {
	...
	methods: {
		...mapActions("commonProductFields", ["fetchTableData", "addTableData", "deleteTableData", "updateTableData"]),
		...mapGetters("commonProductFields", ["getCommonProductFields"]),
		initializeTableData(params = { page: 0, docsPerPage: 10 }) {
			this.initializeData(this.fetchTableData, this.getCommonProductFields, params)
