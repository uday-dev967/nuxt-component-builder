...
export default {
	name: "PlumbingFixtureParametersPage",
	components: {
	...
	methods: {
		...mapActions("plumbingFixtureParameters", [
			"fetchTableData",
			"addTableData",
			"deleteTableData",
			"updateTableData",
		]),
		...mapGetters("plumbingFixtureParameters", ["getPlumbingFixtureParameters"]),
		initializeTableData(params = { page: 0, docsPerPage: 10 }) {
			this.initializeData(this.fetchTableData, this.getPlumbingFixtureParameters, params)
