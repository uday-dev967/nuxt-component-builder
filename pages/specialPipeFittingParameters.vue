...
export default {
	name: "SpecialPipeFittingParametersPage",
	components: {
	...
	methods: {
		...mapActions("specialPipeFittingParameters", [
			"fetchTableData",
			"addTableData",
			"deleteTableData",
			"updateTableData",
		]),
		...mapGetters("specialPipeFittingParameters", ["getSpecialPipeFittingParameters"]),
		initializeTableData(params = { page: 0, docsPerPage: 10 }) {
			this.initializeData(this.fetchTableData, this.getSpecialPipeFittingParameters, params)
